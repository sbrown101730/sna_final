...
funny_igraph <- graph.adjacency(as.matrix.network(funny_net)) 
...
## 3. Subreddits have a preferential indegree attachement --> want to determine whether funny is a hub or an authority node.
