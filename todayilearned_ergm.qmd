...
V(giantGraph_todayilearned)$popularity_numeric <- as.numeric(factor(V(giantGraph_todayilearned)$popularity, levels = c("missing", "small", "medium", "large")))

plot(giantGraph_todayilearned, vertex.size = V(giantGraph_todayilearned)$popularity_numeric, vertex.color = "lightblue", edge.color = "darkblue")
